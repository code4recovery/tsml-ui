// Translates Google Sheet JSON into MG Format JSON
export function translateGoogleSheet(data){
	// For example of Google Sheet see Cateret County Example on https://github.com/meeting-guide/spreadsheet
	...
	// takes the Google Sheet data and translates it to required MG specifications
